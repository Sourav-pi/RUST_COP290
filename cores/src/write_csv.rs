...
impl Sheet {
    ...
    /// sheet.update_cell_data(1, 1, String::from("SUM(A2:A5)"));
    /// match sheet.write_csv("spreadsheet.csv") {
    ///     Ok(()) => println!("Spreadsheet saved successfully"),
    ///     Err(e) => eprintln!("Failed to save spreadsheet: {}", e),
    /// }
    /// ```
    ///
    /// # CSV Format
...
// Test code - commented out but can be used for testing
// #[test]
// fn test_write_csv() {
